...
<html>
  ...
  <body>
   ...
   <div class="container">
   		...
   		<div class="span8">
   			<form action="document.jspx?_d=save_document" method="post">
   				<fieldset>
   					<legend>分享新资料</legend>
   					<div class="control-group">
   						<label class="control-label">标题</label>
   						<div class="controls">
   							<input type="text" name="biaoTi" id="input01">
   						</div>
   					</div>
   					<div class="control-group">
   						<label class="control-label">内容</label>
   						<div class="controls">
   							<textarea id="editor_id" name="content" style="width:620px;height:100px;"></textarea>
    					<p>
   					...
   					<div class="form-actions">
   						<input type="submit" id="input01" name="" value="提交" class="btn btn-primary">&nbsp;&nbsp;
   						<a class="btn btn-info" href="document.jspx">返回</a>
   					</div>
